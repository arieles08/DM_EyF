...
#----------------TendenciaYmuchomas---ratioavg=FALSE--ratiomax=FALSE---------------------------------------------------------
...
if( PARAM$Tendencias )
{
  TendenciaYmuchomas( dataset, 
                      ...
                      tendencia= TRUE,
                      minimo=    TRUE, #L: lo cambio a TRUE
                      maximo=    TRUE, #L: lo cambio a TRUE
                      promedio=  TRUE,
                      ratioavg=  TRUE, #L: lo cambio a TRUE
                      ratiomax=  TRUE )#L: lo cambio a TRUE
}
