...
hs <- makeParamSet( 
         ...
         makeIntegerParam("num_leaves",       lower=   50L   , upper=  2048L),
         makeIntegerParam("envios",           lower= 5000L   , upper= 13000L),
         makeIntegerParam("max_bin",          lower=   25L   , upper=  100L)
...
PARAM$input$dataset       <- "./datasets/01.competencia2_2022_cfix_fe_v1.csv"
...
PARAM$trainingstrategy$semilla_azar   <- 581407  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 581407  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
