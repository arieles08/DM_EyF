...
PARAM$final_train  <- c(202011, 202012, 202101, 202102, 202103, 202104, 202105 ) #elijo 7 meses

PARAM$train$training     <- c(202009, 202010, 202011, 202012, 202101, 202102, 202103)
PARAM$train$validation   <- c( 202104 )
PARAM$train$testing      <- c( 202105 )
PARAM$train$undersampling  <- 0.9   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
PARAM$train$semilla  <- 130631
