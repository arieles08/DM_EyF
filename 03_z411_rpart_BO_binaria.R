...
hs  <- makeParamSet(
          ...
          makeIntegerParam("maxdepth" , lower=   15L,  upper=   30L),  #la letra L al final significa ENTERO
...
dataset  <- fread("./datasets/competencia1_2022_fe1.csv")   #donde entreno
